  ...
  def create
    ...
    respond_to do |format|
      if @keyword_mapping.save
        format.html { redirect_to keyword_mapping_url(@keyword_mapping), notice: "Keyword mapping was successfully created." }
  ...
  def update
    respond_to do |format|
      if @keyword_mapping.update(keyword_mapping_params)
        format.html { redirect_to keyword_mapping_url(@keyword_mapping), notice: "Keyword mapping was successfully updated." }
